...
import pandas as pd  # 新增表格依赖
from sklearn.metrics import accuracy_score, recall_score, f1_score  # 新增指标计算
import sys  # 添加这行代码
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for step, data in enumerate(train_loader):
            ...
            train_preds.extend(pred_classes.cpu().numpy())  # 保存预测标签
        ...
        for step, data in enumerate(val_loader):
            ...
            val_labels.extend(labels.cpu().numpy())  # 真实标签
            val_preds.extend(pred_classes.cpu().numpy())  # 预测标签
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="/your/absolute/path/to/your_dataset")
